...
PERMISSION_CODES = getattr(settings, "TEAM_MANAGEMENT_ADMIN_PERMISSIONS", DEFAULT_ADMIN_PERMISSION_CODES)
...
class RoleProtectedAdmin(admin.ModelAdmin):
	...
	def has_module_permission(self, request) -> bool:
		return self._is_staff(request) and self._has_permission(request.user, self.module_permission_key)
	...
	def has_add_permission(self, request) -> bool:
		return self._is_staff(request) and self._has_permission(request.user, self.add_permission_key)
